...
namespace CodeCodeChallenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        public async Task GetReportingStructure_Returns_ReportingStructure(string employeeId, int expectedReportsCount) 
        {
            // Execute
            var response = await _httpClient.GetAsync($"api/employee/{employeeId}/reporting-structure");
        ...
        [TestMethod]
        public async Task GetReportingStructure_Returns_BadRequest()
        {
            // Arrange
            var employeeId = " ";
